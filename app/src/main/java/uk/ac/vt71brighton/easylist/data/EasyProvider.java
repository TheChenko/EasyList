...
/**
 * {@link ContentProvider} for EasyList app.
 */
public class EasyProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        mDbHelper = new EasyDbHelper(getContext());
        return true;
    }
    ...
    private int updateItem(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int rowsUpdated = database.update(EListEntry.TABLE_NAME, values, selection, selectionArgs);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case EL:
                ...
                rowsDeleted = database.delete(EListEntry.TABLE_NAME, selection, selectionArgs);
                break;
            case EL_ID:
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case EL:
                return EListEntry.CONTENT_LIST_TYPE;
            case EL_ID:
                return EListEntry.CONTENT_ITEM_TYPE;
            default:
